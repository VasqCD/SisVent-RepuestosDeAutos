...
@PageTitle("Proveedor")
@Route(value = "proveedor/:samplePersonID?/:action?(edit)", layout = MainLayout.class)
@Uses(Icon.class)
public class ProveedorView extends Div implements BeforeEnterObserver {
    ...
    public ProveedorView(SamplePersonService samplePersonService) {
